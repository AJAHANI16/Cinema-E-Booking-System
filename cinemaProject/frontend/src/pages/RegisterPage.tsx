                    ...
                    <div className="mt-4">
                        <form className="flex justify-center items-center flex-col bg-white p-6 rounded-lg shadow-md">
                            <div className="w-full">
                                ...
                                <input type="text" id="username" name="username" required className="w-full border border-gray-300 rounded-lg px-4 py-2 mb-4"/>
                            </div>
                            <div className="w-full">
                            ...
                            <button type="submit" className="mt-4 px-4 py-2 bg-blue-500 text-white rounded cursor-pointer">Register</button>
                            <a href="/login" className="mt-2 text-blue-500 hover:underline">Already have an account? Login</a>
                        </form>
