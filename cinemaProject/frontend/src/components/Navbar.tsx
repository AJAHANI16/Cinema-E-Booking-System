...
export default function Navbar({ onSearch, onFilter, movies }: NavbarProps) {
  ...
  return (
    <nav className="backdrop-blur-md bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-gray-700 shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-5 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        {/* Logo / Site title */}
        <Link
          to="/"
        ...
        {/* Search + Filter */}
        {onSearch && onFilter && (
          <div className="flex flex-wrap items-center gap-3 bg-gray-800/70 px-4 py-2 rounded-lg shadow-inner border border-gray-700">
            <input
              type="text"
